      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="mailto:asifjarif@gmail.com"
          ...
          <div className="flex justify-center gap-6">
            ...
            <a
              href="https://www.linkedin.com/in/md-asif-chowdhury-xarif/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
            >
            ...
            <a
              href="https://www.facebook.com/xarif.axc"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.342v3.209h2.753v8.196h3.302z" />
              </svg>
            </a>
          </div>
        </motion.div>
